    ...
    <asp:Panel ID="PnlRegister" runat="server">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group">
                    <asp:TextBox ID="TxtbxPasswordCheck" style="margin-bottom:1rem" runat="server" type="Password" placeholder="Repeat Password*" CssClass="form-control"></asp:TextBox>
                </div>

                <asp:Button ID="BtnCreateAccount" runat="server" Text="Create Account" CssClass="btn btn-primary btn-md btn-block" style="margin-bottom:1rem" OnClick="BtnCreateAccount_Click" ValidationGroup="Registration"/>
                <a>
                    <asp:Button ID="BtnLogin" runat="server" Text="Log in Instead" CssClass="btn btn-secondary btn-md btn-block" OnClick="BtnLogin_Click" CausesValidation="False"/>
                </a>
                </div>
            </div>
            <div class="col-md-4"></div>
