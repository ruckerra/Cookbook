        ...
        <div class="row">
            ...
            <div id="LoginInput" class="col-md-4">
                    ...
                    <div class="input-group" style="margin-bottom:1rem">
                        ...
                        <asp:TextBox ID="TxtbxIdentifier" runat="server" style="margin-bottom:1rem" placeholder="Username or Email" CssClass="form-control npt"></asp:TextBox>
                        <br />
                        ...
                        <asp:TextBox ID="TxtbxPassword" runat="server" type="Password" placeholder="Password" CssClass="form-control npt" style="margin-bottom:1rem"></asp:TextBox>
                        <br />
                        <div style="display:inline-block">&nbsp</div>
                        <asp:Button ID="BtnSubmit" runat="server" style="margin-bottom:1rem" Text="Log In" CssClass="btn btn-primary btn-block btn-frost btn-oline-primary" class="form-control" ValidationGroup="Login" OnClick="BtnSubmit_Click"/>
                        <a>
                            <asp:Button ID="BtnRegister" runat="server" style="margin-bottom:1rem" Text="Create an Account" CssClass="btn btn-secondary btn-block btn-frost btn-oline-secondary" class="form-control" OnClick="BtnRegister_Click"/>
                        </a>
                </div>
            </div>
            <div class="col-md-4"></div>
