    ...
    <asp:Panel ID="Panel1" runat="server">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <asp:Button ID="btnUpdate" runat="server" Text="Update" style="display:block;width:80px" CssClass="btn btn-primary btn-md" OnClick="btnUpdate_Click"/>
                <asp:Button ID="btnSignOut" runat="server" style="display:block;width:80px" CssClass="btn btn-danger btn-md" Text="Sign Out" Visible="false" OnClick="btnSignOut_Click"/>
