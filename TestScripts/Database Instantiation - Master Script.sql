...
CREATE SCHEMA virtual_cookbook;
GO
...
CREATE SEQUENCE recipe_id_seq AS BIGINT START WITH 1 INCREMENT BY 1;

GO

CREATE TABLE users(
	user_uid UNIQUEIDENTIFIER NOT NULL PRIMARY KEY DEFAULT NEWID(),
	first_name VARCHAR(25) NOT NULL,
	last_name VARCHAR(25) NOT NULL,
	username VARCHAR(30) NOT NULL,
	date_reg DATE NOT NULL, /*SELECT CONVERT(DATE, GETDATE())*/
	verified BIT,
...
CREATE TABLE recipes(
	recipe_id BIGINT NOT NULL PRIMARY KEY DEFAULT(NEXT VALUE FOR recipe_id_seq), /*Use negative values to see recipes waiting to be approved*/
...
INSERT INTO users(user_uid, first_name, last_name, username, date_reg, verified)
	VALUES('8a94964b-fb4f-4801-8426-ff7ba6496481', 'Fun', 'Guy', 'Operator', (SELECT CONVERT(DATE, GETDATE())), 1);
...
VALUES(
(SELECT recipe_name FROM recipes WHERE recipe_id = (SELECT CONVERT(BIGINT, current_value) FROM sys.sequences WHERE name = 'recipe_id_seq') ),
270,
1,
37,
4,
...
INSERT INTO users_recipes(username,recipe_id)
  SELECT 'Operator', (SELECT CONVERT(BIGINT, current_value) FROM sys.sequences WHERE name = 'recipe_id_seq')
  WHERE NOT EXISTS (
    SELECT username, recipe_id FROM users_recipes
      WHERE username = 'Operator' AND recipe_id = (SELECT CONVERT(BIGINT, current_value) FROM sys.sequences WHERE name = 'recipe_id_seq')
  );
...
INSERT INTO nutrition(recipe_name, calories, fat, carbs, fiber, protien, servings)
VALUES((SELECT recipe_name FROM recipes WHERE recipe_id = (SELECT CONVERT(BIGINT, current_value) FROM sys.sequences WHERE name = 'recipe_id_seq')),
270,
1,
30,
6,
